...
namespace LitJson
{
    ...
    public class JsonReader
    {
        ...
        private bool ReadToken ()
        {
			...
			bool hasNextToken = lexer.NextToken ();
            if (hasNextToken)
        ...
        public bool Read ()
        {
            ...
            while (true) {
                ...
                try {
					...
					if (current_symbol == (int)ParserToken.Text && !(parse_table[current_symbol]).ContainsKey(current_input)) {
						entry_symbols = new int[]{(int)ParserToken.Value};
					} else 
