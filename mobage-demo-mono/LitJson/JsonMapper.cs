...
namespace LitJson
{
    ...
    public class JsonMapper
    {
...
#else
			throw new JsonException(string.Format("Can not parse to {0} without System.Reflection.", inst_type));
#endif
            }
        ...
        private static void RegisterBaseImporters ()
        {
            ...
            /* Using float type for optimization purposes
			importer = delegate (object input) {
                                        ...
                                        int depth)
        {
            ...
            foreach (PropertyMetadata p_data in props) {
                ...
                /* sparedes 20130802: Disable property inspection to avoid circular references which are likely to happen on this.
                 else {
            ...
            writer.WriteObjectEnd ();
#else
			throw new JsonException(string.Format("Can not serialize {0} without System.Reflection.", obj_type));
#endif
        }
        #endregion
